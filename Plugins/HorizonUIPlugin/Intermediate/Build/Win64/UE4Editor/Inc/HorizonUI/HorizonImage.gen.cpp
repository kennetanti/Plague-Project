...
#include "HorizonUI/Public/Widget/HorizonImage.h"
#ifdef _MSC_VER
#pragma warning (push)
...
// End Cross Module References
...
#endif
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UClass_UHorizonImage_Statics::NewProp_UVRegion = { UE4CodeGen_Private::EPropertyClass::Struct, "UVRegion", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000000000015, 1, nullptr, STRUCT_OFFSET(UHorizonImage, UVRegion), Z_Construct_UScriptStruct_FBox2D, METADATA_PARAMS(Z_Construct_UClass_UHorizonImage_Statics::NewProp_UVRegion_MetaData, ARRAY_COUNT(Z_Construct_UClass_UHorizonImage_Statics::NewProp_UVRegion_MetaData)) };
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_UHorizonImage_Statics::ClassParams = {
		...
		0x00B000A0u,
		nullptr, 0,
		Z_Construct_UClass_UHorizonImage_Statics::PropPointers, ARRAY_COUNT(Z_Construct_UClass_UHorizonImage_Statics::PropPointers),
		nullptr,
		&StaticCppClassTypeInfo,
		nullptr, 0,
		METADATA_PARAMS(Z_Construct_UClass_UHorizonImage_Statics::Class_MetaDataParams, ARRAY_COUNT(Z_Construct_UClass_UHorizonImage_Statics::Class_MetaDataParams))
	};
	...
	IMPLEMENT_CLASS(UHorizonImage, 198741323);
