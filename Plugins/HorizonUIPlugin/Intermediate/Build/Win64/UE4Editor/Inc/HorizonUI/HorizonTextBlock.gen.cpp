...
#include "HorizonUI/Public/Widget/HorizonTextBlock.h"
#ifdef _MSC_VER
#pragma warning (push)
...
// End Cross Module References
	...
	const UE4CodeGen_Private::FBytePropertyParams Z_Construct_UFunction_UHorizonTextBlock_GetJustification_Statics::NewProp_ReturnValue = { UE4CodeGen_Private::EPropertyClass::Byte, "ReturnValue", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000000000580, 1, nullptr, STRUCT_OFFSET(HorizonTextBlock_eventGetJustification_Parms, ReturnValue), Z_Construct_UEnum_Slate_ETextJustify, METADATA_PARAMS(nullptr, 0) };
...
#endif
	const UE4CodeGen_Private::FFunctionParams Z_Construct_UFunction_UHorizonTextBlock_GetJustification_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UHorizonTextBlock, "GetJustification", RF_Public|RF_Transient|RF_MarkAsNative, nullptr, (EFunctionFlags)0x54020401, sizeof(HorizonTextBlock_eventGetJustification_Parms), Z_Construct_UFunction_UHorizonTextBlock_GetJustification_Statics::PropPointers, ARRAY_COUNT(Z_Construct_UFunction_UHorizonTextBlock_GetJustification_Statics::PropPointers), 0, 0, METADATA_PARAMS(Z_Construct_UFunction_UHorizonTextBlock_GetJustification_Statics::Function_MetaDataParams, ARRAY_COUNT(Z_Construct_UFunction_UHorizonTextBlock_GetJustification_Statics::Function_MetaDataParams)) };
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UHorizonTextBlock_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UHorizonTextBlock_GetJustification, "GetJustification" }, // 1344204949
	};
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_UHorizonTextBlock_Statics::ClassParams = {
		...
		nullptr, 0,
		METADATA_PARAMS(Z_Construct_UClass_UHorizonTextBlock_Statics::Class_MetaDataParams, ARRAY_COUNT(Z_Construct_UClass_UHorizonTextBlock_Statics::Class_MetaDataParams))
	};
	...
	IMPLEMENT_CLASS(UHorizonTextBlock, 596377548);
